...
curl="/usr/bin/curl"
identifier="Kajian_kitab_Tafsir_Jalalain"
...
det=`date +%m_%d_%Y`
namefile="Kajian_Kitab_Tafsir_Jalalain_SuaraNabawiyRaw${hariH}${blnH}${thnH}_${det}.mp3"
#savefile="/home/alfaqir/Majelis/sabtu/$namefile"
path_save="$path_script/Majelis/SN/TJ_${blnH}_${thnH}"
...
if [ -f $savefile ] ; then
	...
	--header 'x-archive-meta-description: Ini adalah arsip kajian kitab Tafsir Jalalain (raw shoutcast dan LIVE Streaming) bulan '${blnH}' '${thnH}' di SuaraNabawiy.com Sabtu sore' \
