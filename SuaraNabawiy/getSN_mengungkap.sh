...
curl="/usr/bin/curl"
identifier="Mengungkap_Hukum_Islam"
...
det=`date +%m_%d_%Y`
namefile="Mengungkap_Hukum_Islam_SuaraNabawiyRaw${hariH}${blnH}${thnH}_${det}.mp3"
#savefile="/home/alfaqir/selasa/$namefile"
path_save="$path_script/Majelis/SN/MengungkapHukumIslam_${blnH}_${thnH}"
...
if [ -f $savefile ] ; then
	...
	--header 'x-archive-meta-description: Ini adalah arsip Tanya jawab Mengungkap Hukum-hukum Islam bersama Al-Habib Taufiq bin Abdul Qadir Assegaf Pasuruan (raw shoutcast dan LIVE Streaming) bulan '${blnH}' '${thnH}' di SuaraNabawiy.com Selasa malam' \
