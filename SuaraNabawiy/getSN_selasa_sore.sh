...
det=`date +%m_%d_%Y`
namefile="Hadroh_Basaudan_SuaraNabawiyRaw${hariH}${blnH}${thnH}_${det}.mp3"
...
if [ -f $savefile ] ; then
	...
	--header 'x-archive-meta-description: Ini adalah arsip Hadroh Bausadan (raw shoutcast dan LIVE Streaming) bulan '${blnH}' '${thnH}' di SuaraNabawiy.com Selasa sore' \
